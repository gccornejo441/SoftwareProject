...
public class AlertMessage {
    ...
    public static void errorPart(int code, TextField field) {
        ...
        switch (code) {
            ...
            case 5: {
                alert.setContentText("Cannot be negative or 0.");
                break;
            }
            case 6: {
            ...
            default: {
                alert.setContentText("Error, please see sys admin.");
                break;
            }
        }
        alert.showAndWait();
    ...
    public static void errorProduct(int code, TextField field) {
        ...
        switch (code) {
            ...
            case 2: {
                alert.setContentText("Part already included.");
                break;
            }
            case 3: {
                alert.setContentText("Invalid format.");
            ...
            case 6: {
                alert.setContentText("Product cost cannot be lower than parts.");
                break;
            }
            case 7: {
